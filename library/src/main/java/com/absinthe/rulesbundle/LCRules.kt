...
object LCRules {
    ...
    suspend fun getRule(libName: String, @LibType type: Int, useRegex: Boolean, language: String = "en"): Rule? =
        synchronized(this) { reader?.getRule(libName, type, useRegex, remoteRepo, language) }
